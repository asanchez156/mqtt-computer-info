...
CPU_temperature_command = "istats cpu | awk '{print $3}' | tr -dc '0-9\.'"
GPU_temperature_command = "istats extra TG0D | awk '{print $6}' | tr -dc '0-9\.'"
battery_temperature_command = "istats battery temp | awk '{print $3}' | tr -dc '0-9\.'"
